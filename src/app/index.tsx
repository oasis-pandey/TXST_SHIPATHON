...
const styles = StyleSheet.create({
  page: { flex: 1, backgroundColor: '#FFFDF9' }, safeArea: { flex: 1, position: 'relative', overflow: 'hidden' }, header: { position: 'absolute', top: 0, left: 20, right: 20, zIndex: 10, height: 72, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, eyebrow: { fontSize: 10, fontWeight: '800', letterSpacing: 1.8, color: '#F8EEE7' }, heading: { fontSize: 27, fontWeight: '700', letterSpacing: -0.8, color: '#FFFFFF', marginTop: 3, textShadowColor: 'rgba(0,0,0,0.25)', textShadowRadius: 8 }, filterButton: { width: 42, height: 42, borderRadius: 21, backgroundColor: 'rgba(255,255,255,0.86)', alignItems: 'center', justifyContent: 'center' }, filterIcon: { fontSize: 25, color: '#564A42', transform: [{ rotate: '90deg' }] },
  progressRow: { position: 'absolute', top: 72, left: 20, right: 20, zIndex: 10, flexDirection: 'row', gap: 5 }, progress: { flex: 1, height: 3, borderRadius: 2, backgroundColor: 'rgba(255,255,255,0.40)' }, progressActive: { backgroundColor: '#FFFFFF' }, deck: { ...StyleSheet.absoluteFill, justifyContent: 'center' }, card: { ...StyleSheet.absoluteFill, zIndex: 2 }, backCard: { position: 'absolute', top: 11, left: 8, right: 8, bottom: 0, transform: [{ scale: 0.97 }], opacity: 0.65 }, cardInner: { flex: 1, overflow: 'hidden', backgroundColor: '#D5A091' }, photo: { ...StyleSheet.absoluteFill }, photoTint: { ...StyleSheet.absoluteFill, opacity: 0.12 }, cardContent: { marginTop: 'auto', padding: 22, paddingTop: 78, paddingBottom: 126, backgroundColor: 'rgba(20, 15, 13, 0.44)' }, nameRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, name: { color: '#fff', fontSize: 30, lineHeight: 36, letterSpacing: -1, fontWeight: '700' }, infoButton: { width: 25, height: 25, borderRadius: 13, borderWidth: 1.5, borderColor: '#fff', alignItems: 'center', justifyContent: 'center' }, infoIcon: { color: '#fff', fontWeight: '800', fontSize: 15 }, distance: { color: '#F8F4F1', fontSize: 13, marginTop: 6, fontWeight: '600' }, tags: { flexDirection: 'row', flexWrap: 'wrap', gap: 7, marginTop: 15 }, tag: { borderRadius: 20, backgroundColor: 'rgba(255,255,255,0.19)', paddingHorizontal: 11, paddingVertical: 6 }, tagText: { color: '#fff', fontSize: 12, fontWeight: '600' }, bio: { color: '#fff', fontSize: 13, lineHeight: 19, marginTop: 14 },
  stamp: { position: 'absolute', top: 116, zIndex: 4, borderWidth: 4, borderRadius: 8, paddingHorizontal: 9, paddingVertical: 2, fontSize: 31, fontWeight: '900', letterSpacing: 1, backgroundColor: 'rgba(255,255,255,0.16)' }, nopeStamp: { left: 25, color: '#F16868', borderColor: '#F16868', transform: [{ rotate: '-16deg' }] }, likeStamp: { right: 25, color: '#50D09E', borderColor: '#50D09E', transform: [{ rotate: '16deg' }] }, actions: { position: 'absolute', zIndex: 10, left: 0, right: 0, bottom: 24, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 15 }, actionButton: { backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center', shadowColor: '#856E5D', shadowOpacity: 0.28, shadowRadius: 12, shadowOffset: { width: 0, height: 5 }, elevation: 6 }, actionSmall: { width: 48, height: 48, borderRadius: 24 }, actionLarge: { width: 62, height: 62, borderRadius: 31 }, actionIcon: { fontSize: 26, fontWeight: '400', lineHeight: 30 }, actionIconLarge: { fontSize: 37, lineHeight: 40 }, hint: { position: 'absolute', zIndex: 10, left: 0, right: 0, bottom: 7, color: 'rgba(255,255,255,0.76)', fontSize: 12, textAlign: 'center', textShadowColor: 'rgba(0,0,0,0.35)', textShadowRadius: 4 }, emptyState: { flex: 1, backgroundColor: '#F9F1EA', alignItems: 'center', justifyContent: 'center', padding: 36 }, emptyEmoji: { fontSize: 44, marginBottom: 14 }, emptyTitle: { fontSize: 22, fontWeight: '700', color: '#342A25' }, emptyCopy: { color: '#83756C', lineHeight: 20, textAlign: 'center', marginTop: 9 }, refreshButton: { marginTop: 22, backgroundColor: '#D77969', borderRadius: 24, paddingVertical: 12, paddingHorizontal: 22 }, refreshText: { color: '#fff', fontWeight: '700' },
});
